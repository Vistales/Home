...
data <- read.csv("C:/Users/Pc/Documents/Data/dataset.csv") # Place your data transformation code here 
...
:::: {.row .row-body-outset style="background-color: #F3EFAE;margin:10% 25% 5% 25%;padding:5%; font-family:fraunces; font-size: 4vh; color:#FFF895;"}
