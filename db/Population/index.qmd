...
plot_ly(df, labels = ~variable, values = ~value, type = 'pie', hole = 0.5,marker = list(colors = c('goldenrod', 'navy')),textinfo ='label',textposition = 'inside',direction = 'clockwise', showlegend= FALSE) %>%
